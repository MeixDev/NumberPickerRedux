...
/// Originally created by Marcin Szałek
/// Redux by Meï "MeixDev"
...
class NumberPicker extends StatelessWidget {
  ...
  ///number of numbers to be displayed at any one time, must be an odd number
  ...
  ///Text styles for both the currently selected value and the other displayed values
  ...
  Widget _integerListView(ThemeData themeData) {
    TextStyle defaultStyle = defaultTextStyle ?? themeData.textTheme.bodyText2;
    TextStyle selectedStyle = selectedValueTextStyle ??
              ...
              new ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  bool isExtra = index <= numberToDisplay ~/ 2 - 1 ||
                      index >= listItemCount - (numberToDisplay ~/ 2);
              ...
              new ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  bool isExtra = index <= numberToDisplay - 2 ||
                      index >= decimalItemCount - (numberToDisplay - 2);
  ...
  bool _onIntegerNotification(Notification notification) {
    if (notification is ScrollNotification) {
      ...
      int intValueInTheMiddle =
          _intValueFromIndex(intIndexOfMiddleElement + numberToDisplay ~/ 2);
