...
import 'package:number_picker_redux/number_picker_redux.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _initializeNumberPickers() {
    integerNumberPicker = new NumberPicker.integer(
      ...
      step: 10,
      haptics: true,
      selectedValueTextStyle: Theme.of(context).textTheme.headline5.copyWith(color: Colors.deepOrange),
